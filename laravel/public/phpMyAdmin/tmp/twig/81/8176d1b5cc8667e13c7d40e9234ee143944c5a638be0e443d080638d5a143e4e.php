...
class __TwigTemplate_5945ee5308c261fdb52bf455eeb46cfd202ba26dfcd01d72d62373dc21832949 extends Twig_Template
{
    ...
    <fieldset>
        ...
        if (PhpMyAdmin\Util::showIcons("ActionLinksMode")) {
            // line 5
            echo PhpMyAdmin\Util::getImage("b_table_add.png");
        }
        // line 7
        echo "        ";
...
";
    ...
    {
        return new Twig_Source("", "database/create_table.twig", "/home/files/phpmyadmin/release/phpMyAdmin-4.8+snapshot/templates/database/create_table.twig");
    }
}
